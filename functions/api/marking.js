...
const SYSTEM_PROMPT = [
  ...
  "- Use JYUTPING romanization with tone numbers 1-6 (NOT Pinyin); Cantonese has 6 tones, never describe it as 4.",
  "- Use TRADITIONAL CHARACTERS (繁體字), not simplified.",
  "- Cantonese vocabulary diverges from Mandarin: 嘅 NOT 的, 喺 NOT 在, 食 NOT 吃, 飲 NOT 喝, 唔 NOT 不. Use Cantonese sentence-final particles (啊, 嘅, 喎, 啩, 咩, 啦, 嘛).",
  "- Treat Cantonese as a separate language from Mandarin, not a dialect — different grammar, V-O order, 緊 progressive (NOT 在), 有 + V perfective.",
  "- When marking, do NOT correct legitimate Cantonese as if it were Mandarin. A Cantonese-natural form like 我食咗飯 is correct, not an error.",
  "",
  "Format:",
  "",
  "## Error highlights",
